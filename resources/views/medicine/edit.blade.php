                        ...
                        <div class="tab-pane active" id="home">
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <label for="medicine-name" class="col-form-label">medicine
                                        Name:</label>
                                    <input type="text" class="form-control" name="medicine_name" id="name" value={{$medicine->medicine_name}}>
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="number" class="form-control" name="selling_price" id="selling_price" value={{$medicine->selling_price}}
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="number" class="form-control" name="total_quantity" id="quantity"
